...
const AddBudgetPage = () => {
  const { getTotalAmount } = useContext(CategoriesContext) as { getTotalAmount: (type: string) => number };
  ...
  return (
    ...
    <PageContainer>
      <div className="space-y-8">
        <div>
          <Text className="text-xl font-bold text-gray-900 dark:text-gray-100 flex text-center">
